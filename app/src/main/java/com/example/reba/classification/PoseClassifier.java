...
import static com.example.reba.classification.PoseEmbedding.getPoseEmbedding;
import static com.example.reba.classification.Utils.maxAbs;
import static com.example.reba.classification.Utils.multiply;
import static com.example.reba.classification.Utils.multiplyAll;
import static com.example.reba.classification.Utils.subtract;
import static com.example.reba.classification.Utils.sumAbs;
...
/**
 *根据给定的{@link PoseSample}对{link Pose}进行分类。
